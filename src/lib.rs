...
#[derive(Debug)]
pub struct MoralGridProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MoralGridProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MoralGrid processing");
    
    let mut processor = MoralGridProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MoralGridProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MoralGridProcessor::new(false);
